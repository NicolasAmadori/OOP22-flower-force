...
public interface Game {
     ...
     */
    Set<Pair<String,Point2D>> getZombies();
     ...
     */
    Set<Pair<String, Point2D>> getBullet();
     ...
     */
    Set<Pair<String,Integer>> getAvailablePlantsIDs();
     ...
     */
    List<Pair<String,Integer>> getAllPlantIDs();
